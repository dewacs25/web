...
$id = $_GET['id'];
$b = mysqli_fetch_array(mysqli_query($conect, "SELECT * FROM tb_partner WHERE id_partner='$id'"));
...
if (isset($_POST['input'])) {
    ...
    unlink('../../../public/img/logo_partner/' . $gambarbaru);
    move_uploaded_file($foto, '../../../public/img/logo_partner/' . $newnama);

    $sql = mysqli_query($conect, "UPDATE `tb_partner` SET `id_partner`='$id', `gambar`='$newnama' WHERE id_partner='$id'");
    if ($sql) {
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                                    ...
                                    <label class="mt-3">Masukan Logo Baru</label>


                                    <div class="input-group mb-3 mt-2">
                                        <input type="hidden" name="gambarb" value="<?= $b['gambar']; ?>">
                                        <input type="file" name="gambar" accept=".jpg, .png, .JPEG, .JPG, .PNG" class="form-control" id="inputGroupFile02" required>
                                        <label class="input-group-text" for="inputGroupFile02">Logo Partner</label>
                                    </div>
