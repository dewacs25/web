                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST">
                                    <?php
                                    $my = mysqli_fetch_array(mysqli_query($conect, "SELECT * FROM tb_footer"));
                                    ?>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control mb-2" type="text" name="nama_email" placeholder="input nama email" class="input-200px" required value="<?php echo $my['nama_email']; ?>">
                                    </div>
                                    <div class="input-group mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input class="form-control mb-2" type="text" name="copyright" placeholder="input nama copyright" class="input-200px" required value="<?php echo $my['copyright']; ?>">
                                    </div>
...
if (isset($_POST['editkate'])) {
    ...
    $sqli = mysqli_query($conect, "UPDATE `tb_footer` SET `id`='$id', `no_whatsapp`='$no_whatsapp',`nama_email`='$nama_email',`url_facebook`='$url_facebook',`url_instagram`='$url_instagram',`copyright`='$copyright' WHERE `id`='$id'");
    if ($sqli) {
