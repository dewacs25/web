                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <input type="hidden" name="sejarah_singkat" value="<?= $my['sejarah_singkat'] ?>">
                                    
                                    <textarea name="visi_misi" class="ckeditor" id="ckedtor" placeholder="Isi Sejarah Singkat"><?= $my['visi_misi']; ?></textarea>
...
if (isset($_POST['editkate'])) {
    ...
    if ($sqli) {
        echo "<script>alert('edit berhasil');document.location='index2.php'</script>";
    }
}
?>