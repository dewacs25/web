                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                                    <input class="form-control" type="text" name="judul" placeholder="Masukan Judul" size="50" required autocomplete="off">
                                    <br><br>

                                    <div class="form-floating">
                                        <textarea maxlength="600" name="isi" class="form-control" placeholder="Text panjang max 600" id="floatingTextarea2" style="height: 100px"></textarea>
...
if (isset($_POST['input'])) {
    ...
    $ir = rand();
    $sql = mysqli_query($conect, "INSERT INTO `tb_carousel`(`id_carousel`, `judul`, `isi`, `gambar`) VALUES ('$ir','$judul','$isi','$newnama')");
