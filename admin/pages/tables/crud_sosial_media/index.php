                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST">
                                    <?php
                                    $my = mysqli_fetch_array(mysqli_query($conect, "SELECT * FROM tb_sosial_media"));
                                    ?>
                                    <input type="hidden" name="id" value="<?= $my['id_media'] ?>">
...
if (isset($_POST['editkate'])) {
    ...
    $sqli = mysqli_query($conect, "UPDATE `tb_sosial_media` SET `id_media`='$id', `no_whatsapp`='$no_whatsapp',`email`='$nama_email',`url_facebook`='$url_facebook',`url_instagram`='$url_instagram' WHERE `id_media`='$id'");
    if ($sqli) {
