          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="web_hasil.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Web Hasil</p>
                  </a>
                </li>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Hasil Web</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="crud_hasil_web/tambah.php" class="btn btn-primary mb-2 btn-sm w-100">Tambah</a>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sql = mysqli_query($conect, "SELECT * FROM `tb_web_hasil`");

                    while ($row = mysqli_fetch_array($sql)) { ?>

                      <tr>
                        <td><?= $row['link']; ?></td>
                        <td><img src="../../public/img/web_hasil/<?= $row['gambar'] ?>" style="max-width: 60px;" alt=""></td>
                        
                        <td>
                          <a href="crud_hasil_web/edit.php?id=<?= $row['id_web']; ?>" class="btn btn-warning badge">Edit</a>
                          <a href="crud_hasil_web/hapus.php?id=<?= $row['id_web']; ?>" onclick="return confirm('yakin ingin menghapus')" class="btn btn-danger badge">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
