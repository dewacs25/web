          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="bantuan.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Bantuan</p>
                  </a>
                </li>
                ...
                <div class="table-responsive" style="min-height: 400px;">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <?php
                      $sql = mysqli_query($conect, "SELECT * FROM `tb_bantuan`");
                      ...
                      while ($row = mysqli_fetch_array($sql)) { ?>
                        ...
                        <tr>
                          ...
                          <div class="droend">
                            ...
                            <div class="dropdown-menu bg-transparent border-0 shadow-none" style="max-height: 300px; ">

                              <div class="card" style="width: 20rem; max-height: 100%; min-height: 100%;">
                                <div class="card-body">
                                  <p class="card-text" style="max-height: 200px; overflow: auto;"><?= $row['keterangan'] ?></p>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <td>
                            <a href="hapus_bantuan/hapus.php?id=<?= $row['id_bantuan']; ?>" onclick="return confirm('yakin ingin menghapus')" class="btn btn-danger badge">Hapus</a>
                          </td>
                        </tr>
                      <?php } ?>
