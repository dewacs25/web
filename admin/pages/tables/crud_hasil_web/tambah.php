            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                  <input class="form-control" type="text" name="link" placeholder="Masukan link" size="50" required autocomplete="off">
                  <br>
...
if (isset($_POST['input'])) {
  ...
  $sql = mysqli_query($conect, "INSERT INTO `tb_web_hasil`(id_web,link,gambar) VALUES ('$ir','$link','$newnama')");
  if ($sql) {
