          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="tentang_kami.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tentang kami</p>
                  </a>
                </li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a href="crud_tentang_kami/tambah.php" class="btn btn-primary mb-2 btn-sm w-100">Tambah</a>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sql = mysqli_query($conect, "SELECT * FROM `tb_tentang_kami`");
                    ...
                    while ($row = mysqli_fetch_array($sql)) { ?>
                      ...
                      <tr>
                        <td><?= $row['judul']; ?></td>
                        <td><?= $row['isi']; ?></td>
                        <td><img src="../../public/img/tentang_kami/<?= $row['gambar'] ?>" style="max-width: 60px;" alt=""></td>
                        
                        <td>
                          <a href="crud_tentang_kami/edit.php?id=<?= $row['id']; ?>" class="btn btn-warning badge">Edit</a>
                          <a href="crud_tentang_kami/hapus.php?id=<?= $row['id']; ?>" onclick="return confirm('yakin ingin menghapus')" class="btn btn-danger badge">Hapus</a>
                        </td>
                      </tr>
                    <?php } ?>
